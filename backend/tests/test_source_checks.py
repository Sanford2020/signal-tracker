...
def test_default_provider_registry_routes_search_to_hacker_news() -> None:
    ...
    assert isinstance(registry.get("news"), CompositeSourceProvider)
    assert isinstance(registry.get("funding"), CompositeSourceProvider)
    assert isinstance(registry.get("market"), CompositeSourceProvider)
    assert isinstance(registry.get("policy"), CompositeSourceProvider)
    ...
    assert isinstance(registry.get("careers"), HackerNewsProvider)
    assert isinstance(registry.get("hacker_news"), HackerNewsProvider)
    assert isinstance(registry.get("hiring"), HackerNewsProvider)
    assert isinstance(registry.get("hn"), HackerNewsProvider)
    assert isinstance(registry.get("jobs"), HackerNewsProvider)
